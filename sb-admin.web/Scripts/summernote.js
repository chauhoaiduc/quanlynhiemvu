...
(function (factory) {
  ...
  var Editor = function (context) {
    ...
    //}
    //var url = inputToURL(document.getElementByName('files'));
    //console.log(url);
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                   ...
                   '<input class="note-image-input form-control" type="file" id="files" name="files" accept="image/*" multiple="multiple" />' +
                   imageLimitation +
                 '</div>' +
